...
{
  public TestConstructorInjection(DependsOnStruct dep1, DependsOnClass dep2, IDependsOnInterface dep3)
  {
  }
}

public static class TestFunctionInject
{
  public static void Test(DependsOnStruct dep1, DependsOnClass dep2, IDependsOnInterface dep3)
  {
