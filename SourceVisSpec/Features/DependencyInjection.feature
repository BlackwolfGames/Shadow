Feature: AST parser - DependencyInjection
    ...
    Scenario Outline: Parser tracks parameters, variable declarations and return values
        ...
        Examples:
          ...
          | TestFunctionReturn | 3 | DependsOnClass      | 3 | ReturnType          | 1 |
          | TestFunctionReturn | 3 | DependsOnClass      | 3 | DirectInstantiation | 2 |
          | TestFunctionReturn | 3 | IDependsOnInterface | 1 | ReturnType          | 1 |
          | TestFunctionReturn | 3 | DependsOnStruct     | 1 | ReturnType          | 1 |
